...
The `mse` package makes use of `progressr`, if available, to report on the progress of simulation runs. To get progress bars shown for every call tp `mp()`, please run

```r
handlers(global=TRUE)
```

at the start of your session, or in your `.Rprofile` file.
